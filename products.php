...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Online Petals Yard!</h1>
                    <p>Welcome to online petals yard.Imerge in the beautiful nature feel of flowers.Just  order the beautiful smiling flower pots with the same great smile.</p>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="content">
            <h3>why choose us?</h3>
            <p>Here we are providing the different varieties of flowers in the entire country.
            We are providing them for affordable prices .And due to our numerous branches we 
        can deliver you the flowers you ordered in the very less time.
        You can order in the flexible hours.We can assure you that you will recieve the very fresh flower pots without any damage.</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/img-20.jpeg" alt="">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lavender pot</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/img-21.jpeg" alt="">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Glass pot</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/img-18.jpeg" alt="">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Merry pot</h3>
    ...
    <div class="row">
        ...
        <form action="">
            ...
            <input type="file" id="myfile"name="myfile">Choose the customize image
            <input type="submit" value="send message" class="btn">
        </form>

        <div class="image">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30534.769179191397!2d81.90565087523433!3d16.932879754542594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a379764feac498d%3A0xc5afc2748317a187!2sDwarapudi%20Village%2C%20Andhra%20Pradesh!5e0!3m2!1sen!2sin!4v1674540824382!5m2!1sen!2sin" width="500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
